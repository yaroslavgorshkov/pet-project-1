...
export const categorySectionContent: CategorySectionItem[] = [
    ...
    { id: 1, href: "#dinning-room", text: "Dinning Room", imgRef: "/img/categories-dinning.jpg", alt: "Dinning Room" },
    { id: 2, href: "#meeting-room", text: "Meeting Room", imgRef: "/img/categories-meeting-room.jpg", alt: "Meeting Room" },
    { id: 3, href: "#workspace", text: "Workspace", imgRef: "/img/categories-workspace-room.jpg", alt: "Workspace" },
    { id: 4, href: "#living-room", text: "Living Room", imgRef: "/img/categories-living-room.jpg", alt: "Living Room" },
    { id: 5, href: "#kitchen-room", text: "Kitchen Room", imgRef: "/img/categories-kitchen-room.jpg", alt: "Kitchen Room" },
];
