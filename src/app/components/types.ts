...
export type DynamicIconType = 'account' | 'shopping-cart' | 'search' | 'search-small' | 'hamburger-menu' 
    | 'arrow-up' | 'arrow-down' | 'arrow-left' | 'arrow-right' | 'see-more' | 'zoom' | 'zoom-out'
    | 'twitter' | 'basketball' | 'linked-in' | 'instagram' | 'facebook';
export type StaticIconType = 'payment-method' | 'return-policy' | 'customer-support';
